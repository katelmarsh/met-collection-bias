...
madein_plot <- ggplot(c5_df, aes(x = Freq, y = Var1)) + 
  geom_col() + theme_light() + ggtitle(label = "Art Country, Top 20, MadeIn Geography") + ylab(label = "Country")

library(plotly)

ggplotly(madein_plot)
