...
waffle(culture/1000, rows=10, size=0.6, 
       title="Art Culture", 
...
In this model, the One Rule is the title of the artwork Using the art title, we perform only a little better than random on the dataset and we perform much worse than random on the test set. 
...
```{r}
mod2 <- OneR(is.highlightTrue ~ ., data = train_dat)
summary(mod2)
plot(mod2)
