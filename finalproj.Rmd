...
knitr::include_graphics("~/Downloads/object.id2408.jpeg")
```
...
knitr::include_graphics("~/Downloads/object.id314397.jpeg")
```
...
write.csv(train_dat, "train_dat_cleaned2.csv")
write.csv(test_dat, "test_dat_cleaned2.csv")
...
scatter_plot <- ggplot(data = train_dat, 
                       aes(x = object.end.date, 
                           y = object.begin.date, color = is.highlightTrue))+   
  geom_point() +   
...
knitr::include_graphics("~/Downloads/object.id1083.jpeg")
```
...
knitr::include_graphics("~/Downloads/object.id420178.jpeg")
